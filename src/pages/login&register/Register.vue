...
export default {
  ...
  methods: {
    addUserToDB() {
      ...
      console.log(newUser);
      axios
        .post("http://127.0.0.1:3000/register/checkExistingUser", newUser)
        .then((res) => {
          axios
            .post("http://127.0.0.1:3000/register/createUser", newUser)
            .then((res) => {
              sweetalert({
      ...
      <div class="col-6">
        <form>
          ...
          <div class="text-center">
            <button type="button" class="btn btn-primary" @click="addUserToDB">
              Register
            </button>
          </div>
        </form>
